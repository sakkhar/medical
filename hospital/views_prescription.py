...
from hospital.forms import PrescriptionForm
from hospital.models import Account, Prescription, Action
...
def create_view(request):
    ...
    return render(request, 'hospital/prescription/create.html', template_data)
...
def list_view(request):
    ...
    return render(request, 'hospital/prescription/list.html', template_data)