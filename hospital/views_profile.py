...
from hospital.forms import PasswordForm, ProfileForm, EmployeeProfileForm
from hospital.models import Action, Account, Message
...
def profile_view(request):
    ...
    return render(request, 'hospital/profile.html', template_data)
...
def password_view(request):
    ...
    return render(request, 'hospital/profile/password.html', template_data)
...
def update_view(request):
    ...
    template_data['form'] = form
    return render(request, 'hospital/profile/update.html', template_data)