...
from hospital.forms import MedTestForm, MedTestDisplayForm
from hospital.models import Account, Action, MedicalTest
...
def create_view(request):
    ...
    return render(request, 'hospital/medtest/upload.html', template_data)
...
def list_view(request):
    ...
    return render(request, 'hospital/medtest/list.html', template_data)
...
def display_view(request):
    ...
    return render(request, 'hospital/medtest/display.html', template_data)
...
def update_view(request):
    ...
    if request.user.account.role == Account.ACCOUNT_DOCTOR:
        form.disable_field('doctor')
    template_data['form'] = form
    return render(request, 'hospital/medtest/update.html', template_data)