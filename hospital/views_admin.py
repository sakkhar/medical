...
from hospital.forms import EmployeeRegisterForm, ImportForm, ExportForm, HospitalForm, StatisticsForm

from hospital.models import Account, Action, Hospital, Location, Statistics
...
def users_view(request):
    ...
    return render(request, 'hospital/admin/users.html', template_data)
...
def activity_view(request):
    ...
    return render(request, 'hospital/admin/activity.html', template_data)
...
def add_hospital_view(request):
    ...
    return render(request, 'hospital/admin/add_hospital.html', template_data)
...
def createemployee_view(request):
    ...
    template_data['form'] = form
    return render(request, 'hospital/admin/createemployee.html', template_data)
...
def statistic_view(request):
    ...
    return render(request, 'hospital/admin/statistics.html', template_data)
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            for line in file:
                ...
                template_data['form'] = form
                return render(request, 'hospital/admin/import.html', template_data)
            else:
...
def csv_export_view(request):
    ...
    return render(request, 'hospital/admin/export.html', template_data)
