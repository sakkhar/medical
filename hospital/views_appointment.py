...
from hospital.models import Account, Appointment, Action
...
def list_view(request):
    ...
    return render(request, 'hospital/appointment/list.html', template_data)
...
def calendar_view(request):
    ...
    return render(request, 'hospital/appointment/calendar.html', template_data)
...
def update_view(request):
    ...
    template_data['form'] = form
    return render(request, 'hospital/appointment/update.html', template_data)
...
def create_view(request):
    ...
    if request.user.account.role == Account.ACCOUNT_PATIENT:
        ...
        form.disable_field('doctor')
    template_data['form'] = form
    return render(request, 'hospital/appointment/create.html', template_data)