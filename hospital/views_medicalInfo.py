...
from hospital.forms import MedicalInfoForm
from hospital.models import Action, Account, MedicalInfo
...
def list_view(request):
    ...
    return render(request, 'hospital/medicalinfo/list.html', template_data)
...
def update_view(request):
    ...
    return render(request, 'hospital/medicalinfo/update.html', template_data)