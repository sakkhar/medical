...
from hospital.forms import AdmissionForm
from hospital.models import Account, Admission, Action
...
def admit_view(request):
    ...
    return render(request, 'hospital/admission/admit.html', template_data)
...
def list_view(request):
    ...
    return render(request, 'hospital/admission/list.html', template_data)